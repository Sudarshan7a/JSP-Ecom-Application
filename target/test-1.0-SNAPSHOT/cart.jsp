...
<script>
    (function () {
        ...
        button.addEventListener('click', function () {
            ...
            if (code === 'RCB25') {
                status.innerHTML = '<span class="text-success">Coupon applied in demo mode: 25% display discount unlocked.</span>';
            } else {
                status.innerHTML = '<span class="text-danger">Invalid coupon. Try RCB25.</span>';
            }
        });
    })();
</script>
