    ...
    <nav class="site-navigation text-right text-md-center" role="navigation">
        <div class="container">
            <ul class="site-menu js-clone-nav d-none d-md-block" style="padding: 0">
                ...
                <c:if test="${sessionScope.account != null}">
                    <li class="${order_history_active}"><a href="${pageContext.request.contextPath}/order-history">Orders history</a></li>
                </c:if>

                <c:if test="${sessionScope.account.isSeller == 1}">
                    <li class="${product_management_active}"><a href="${pageContext.request.contextPath}/product-management">Products management</a></li>
                    <li class="${order_management_active}"><a href="${pageContext.request.contextPath}/order-management">Orders management</a></li>
                </c:if>
